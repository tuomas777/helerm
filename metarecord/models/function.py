...
class Function(StructuralElement):
    ...
    validation_start = models.DateField(verbose_name=_('validation start'), null=True, blank=True)
    validation_end = models.DateField(verbose_name=_('validation end'), null=True, blank=True)
